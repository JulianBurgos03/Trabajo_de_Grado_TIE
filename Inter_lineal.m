...
vi1_ev = interp1(1:length(vi1.meas), vi1.meas, linspace(1, length(vi1.meas), length(vi1.meas)), 'linear');
...
Conjugada1_interp = interp1(1:tam_conjugada1, Conjugada1, linspace(1, tam_conjugada1, 256), 'linear')';
