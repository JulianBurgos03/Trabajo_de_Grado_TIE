...
vi1_ev = interp1(1:length(vi1.meas), vi1.meas, linspace(1, length(vi1.meas), length(vi1.meas)), 'spline');
...
Conjugada1_interp = interp1(1:tam_conjugada1, Conjugada1, linspace(1, tam_conjugada1, 256), 'spline')';
...
Conjugada_1= interp1(1:length(Measurements(1,:)), Dezpl_1, linspace(1, length(Measurements(1,:)), 16), 'spline');
Conjugada_2= interp1(1:length(Measurements(2,:)), Dezpl_2, linspace(1, length(Measurements(2,:)), 16), 'spline');
Conjugada_3= interp1(1:length(Measurements(3,:)), Dezpl_3, linspace(1, length(Measurements(3,:)), 16), 'spline');
Conjugada_4= interp1(1:length(Measurements(4,:)), Dezpl_4, linspace(1, length(Measurements(4,:)), 16), 'spline');
Conjugada_5= interp1(1:length(Measurements(5,:)), Dezpl_5, linspace(1, length(Measurements(5,:)), 16), 'spline');
Conjugada_6= interp1(1:length(Measurements(6,:)), Dezpl_6, linspace(1, length(Measurements(6,:)), 16), 'spline');
Conjugada_7= interp1(1:length(Measurements(7,:)), Dezpl_7, linspace(1, length(Measurements(7,:)), 16), 'spline');
Conjugada_8= interp1(1:length(Measurements(8,:)), Dezpl_8, linspace(1, length(Measurements(8,:)), 16), 'spline');
